...
public class OtherPrdsAdapter extends ArrayAdapter<Product> {
    ...
    public OtherPrdsAdapter(Context context, int resource, List<Product> PrdList,long seq) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
     ...
     com.example.Adapter.OtherPrdsAdapter.ViewHolder holder = null;
        if(convertView == null) {
            holder = new com.example.Adapter.OtherPrdsAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.prdlist_item, null);
            ...
            holder = (com.example.Adapter.OtherPrdsAdapter.ViewHolder) convertView.getTag();
        }
