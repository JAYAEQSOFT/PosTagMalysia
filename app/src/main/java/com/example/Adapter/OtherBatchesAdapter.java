...
public class OtherBatchesAdapter extends ArrayAdapter<Product> {
    ...
    public OtherBatchesAdapter(Context context, int resource, List<Product> PrdList,long seq) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        OtherBatchesAdapter.ViewHolder holder = null;
        if(convertView == null) {
            holder = new com.example.Adapter.OtherBatchesAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.batchesprdlist_item, null);

            holder.textView1 = (TextView) convertView.findViewById(R.id.Name);
            holder.textView2 = (TextView) convertView.findViewById(R.id.id);
            holder.textView3 = (TextView) convertView.findViewById(R.id.batchcode);
            ...
            holder = (com.example.Adapter.OtherBatchesAdapter.ViewHolder) convertView.getTag();
        }
        ...
        holder.textView1.setText(PrList.get(position).getName());
        holder.textView2.setText(PrList.get(position).getBatchId().toString());
        String s=PrList.get(position).getBatchCode();
        if(s!=null) {
