...
public class CountersAdapter extends ArrayAdapter<Counter> {
    ...
    private List<Counter> BrList;
    private ArrayList<Counter> objects;
    ...
    public CountersAdapter(Context context, int resource, List<Counter> BrList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CountersAdapter.ViewHolder holder = null;
        if(convertView == null) {
            holder = new CountersAdapter.ViewHolder();
            convertView = inflater.inflate(R.layout.counterlist_item, null);
            ...
            holder = (CountersAdapter.ViewHolder) convertView.getTag();
        }
